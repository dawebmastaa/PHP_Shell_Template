	 ...
	 <form action="<?php echo $ApplicationNonSecureRoot.'main/index/content/formprocessor/';?>" method="post" name="SellForm" id="SellForm" style="padding-left: 0px;" onsubmit="returnValidate('SellForm'); return false;" onkeypress="if(event.keyCode == '13')alert('Please click the \'Sell It Now!\' button, and not press the Enter key.'); return event.keyCode!=13;">
	   ...
	   <label for="SellComments">Additional Comments</label><br />
	 
	   <textarea name="description" id="SellComments" rows="5" cols="60"></textarea><br />

	   <br />
	   <br />
	   <input name="Operation" class="SmallWhiteButton" type="submit" id="Operation" value="Sell It Now!" />
	  </form>
