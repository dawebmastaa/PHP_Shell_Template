...
function ShowPageContent(divList, PageView) {
  ...
  showDivs.forEach(SetVisibleDivs); //document.getElementById('SiteBuilder').style.display = 'block';
  ...
  function SetVisibleDivs(item) {
    ...
    document.getElementById(item).style.visibility = 'visible'; //document.getElementById('SiteBuilder').appendChild(document.getElementById(item));
  }
}
